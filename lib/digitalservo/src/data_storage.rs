...
impl <T, P, const ROWSIZE: usize, const DATALEN: usize> DataStorage <T, P, ROWSIZE, DATALEN> where 
    T: std::fmt::Display + std::fmt::Debug + num_traits::Num + std::clone::Clone + std::marker::Copy,
    P: AsRef<Path>,
{
