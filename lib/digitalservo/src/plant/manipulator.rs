...
impl <T: Float + Default + std::ops::AddAssign + num_traits::Float> SeriesLinkManipulator<T> {
  ...
  fn update_position(&mut self) {
    ...
    self.d0x[0] = self.link[0] * theta[0].sin() + self.link[1] * theta[1].sin() + self.link[2] * theta[2].sin();
    self.d0x[1] = self.link[0] * theta[0].cos() + self.link[1] * theta[1].cos() + self.link[2] * theta[2].cos();
  }
  ...
  fn update_jacobian(&mut self) {
    ...
    self.jacobian = Matrix::from([
      [
        self.link[0] * theta[0].cos() + self.link[1] * theta[1].cos() + self.link[2] * theta[2].cos(), 
        self.link[1] * theta[1].cos() + self.link[2] * theta[2].cos(),
        self.link[2] * theta[2].cos()
      ],
      [
        - self.link[0] * theta[0].sin() - self.link[1] * theta[1].sin() - self.link[2] * theta[2].sin(),
    ...
    self.djacobian = Matrix::from([
      [
        - self.link[0] * dtheta[0] * theta[0].sin() - self.link[1] * dtheta[1] * theta[1].sin() - self.link[2] * dtheta[2] * theta[2].sin(),
        - self.link[1] * dtheta[1] * theta[1].sin() - self.link[2] * dtheta[2] * theta[2].sin(),
        - self.link[2] * dtheta[2] * theta[2].sin()
      ],
      [
        - self.link[0] * dtheta[0] * theta[0].cos() - self.link[1] * dtheta[1] * theta[1].cos() - self.link[2] * dtheta[2] * theta[2].cos(),
        - self.link[1] * dtheta[1] * theta[1].cos() - self.link[2] * dtheta[2] * theta[2].cos(),
  ...
  pub fn computed_torque_method(&mut self, ddx_ref: &[T; WORKSPACE_DIM], ddx_null: &[T; JOINTSPACE_DIM]) -> [T; JOINTSPACE_DIM] {
