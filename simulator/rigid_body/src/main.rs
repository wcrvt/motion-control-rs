...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let rotation_axis_norm: f64 =
        (rotation_axis[0].powi(2) + rotation_axis[1].powi(2) + rotation_axis[2].powi(2)).sqrt();
    let rotation_axis: [f64; 3] = [
        rotation_axis[0] / rotation_axis_norm,
        rotation_axis[1] / rotation_axis_norm,
        rotation_axis[2] / rotation_axis_norm,
    ];
    ...
    for _ in 0..SLOOP_NUM {
        ...
        data_storage_quate.add([
            t, q_cmd[0], q_cmd[1], q_cmd[2], q_cmd[3], q_res[0], q_res[1], q_res[2], q_res[3],
